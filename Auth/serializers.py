...
from Auth.models import User,Profile,Rating,Reviews
from helpers.validators import validate_phone_number
from helpers.socialauth.socialvalidators import GoogleAuthHandler, FacebookAuthHandler
...
class FacebookAuthSerializer(serializers.Serializer):
    ...
    def validate_auth_token(self, auth_token):
        ...
        first_and_second_name = user_data.get('name').split()
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('id','user','phone_no','first_name','last_name','email', 
            'location','details', 'profile_pic','Deals','average_rating')
        model = Profile
        extra_kwargs = {
            'user': {
                'read_only': True
