...
class Wallet(BaseAbstractModel):
    ...
    wallet_accountReference = models.CharField(max_length=100,blank=True)
    wallet_accountName = models.CharField(max_length=100,blank=True)
    wallet_accountNumber = models.CharField(max_length=250,blank=True)
    wallet_bankName = models.CharField(max_length=250,blank=True)
    wallet_bankCode = models.CharField(max_length=250,blank=True)
    wallet_reservationReference = models.CharField(max_length=250,blank=True)
